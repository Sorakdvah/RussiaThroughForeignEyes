    ...
    const contents = {
        'about': `
            <div class="content-section">
                <h2>О проекте</h2>
                <img height="150" src="https://sorakdvah.github.io/RussiaThroughForeignEyes/q.jpg" alt="О проекте" class="section-image">
        ...
        'contacts': `
            <div class="content-section">
                ...
                <div class="contact-info">
                    <p>Сообщения об обнаржуенных ошибках или неточностях, а также благодарности, критику и угрозы, пожалуйста, направляйте по адресу: russiathroughforeigneyes@gmail.com</p>
                </div>
            </div>
        `
    };
